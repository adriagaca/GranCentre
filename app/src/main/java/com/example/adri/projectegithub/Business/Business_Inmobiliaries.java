...
public class Business_Inmobiliaries extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Link1 = findViewById(R.id.LinkPrimeraInmobiliaria);
        Link1.setOnClickListener(this);
        Link2 = findViewById(R.id.LinkSegonaInmobiliaria);
        Link2.setOnClickListener(this);
        Link3 = findViewById(R.id.LinkTerceraInmobiliaria);
        Link3.setOnClickListener(this);
        Link4 = findViewById(R.id.LinkQuartaInmobiliaria);
        Link4.setOnClickListener(this);
        Link5 = findViewById(R.id.LinkCinquenaInmobiliaria);
        Link5.setOnClickListener(this);
        Tlf1 = findViewById(R.id.TlfInmobiliaria1);
        Tlf1.setOnClickListener(this);
        Tlf2 = findViewById(R.id.TlfInmobiliaria2);
        Tlf2.setOnClickListener(this);
        Tlf3 = findViewById(R.id.TlfInmobiliaria3);
        Tlf3.setOnClickListener(this);
        Tlf4 = findViewById(R.id.TlfInmobiliaria4);
        Tlf4.setOnClickListener(this);
        Tlf5 = findViewById(R.id.TlfInmobiliaria5);
        Tlf5.setOnClickListener(this);
        Ubi1 = findViewById(R.id.iubi1);
        Ubi1.setOnClickListener(this);
        Ubi2 = findViewById(R.id.iubi2);
        Ubi2.setOnClickListener(this);
        Ubi3 = findViewById(R.id.iubi3);
        Ubi3.setOnClickListener(this);
        Ubi4 = findViewById(R.id.iubi4);
        Ubi4.setOnClickListener(this);
        Ubi5 = findViewById(R.id.iubi5);
    ...
    public void onClick(View v) {
        if(v==Link1)
        {
            startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("www.barbanygranollers.com/")));
        ...
        {
            startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https//:www.Inmobiliarialaperla.cat/")));

        }
        else if (v==Link4)
        {
            startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("www.intecat.com/es/granollers.php")));

        }
        else if (v==Link5)
        {
            startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https//:www.mesquemascotes.com/")));

        }
        else if (v==Tlf1)
        {
            startActivity(new Intent(Intent.ACTION_DIAL,Uri.parse("tel:+34912345678")));
        }
        else if (v==Tlf2)
        {
